...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { color: @widget.color, name: @widget.name, quantity: @widget.quantity } }, as: :json
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { color: @widget.color, name: @widget.name, quantity: @widget.quantity } }, as: :json
    assert_response 200
  end
